"""Generate submissions using best models from Experiment 8.

Men's: Torvik shallow LGB (d=3, n=400, lr=0.02) — Brier 0.1543
Women's: iter_eff LR(28%) + tier2 LR(72%) blend — Brier 0.1387
"""
...
def generate_submission(data, stage):
    ...
    # --- Women's: tier2 LR C=0.1 (72%) + iter_eff LR C=0.1 (28%) ---
    ...
    path = SUBMISSIONS_DIR / f"submission_stage{stage}_v3_{ts}.csv"
